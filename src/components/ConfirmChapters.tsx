      ...
      <div className="flex items-center justify-center mt-4">
        ...
        <div className="flex items-center mx-4">
          ...
          {totalChaptersCount === completedChapters.size ? (
            <Link
              className={buttonVariants({
                className: "ml-4 font-semibold bg-violet-600 hover:bg-violet-400",
              })}
            ...
            <Button
              type="button"
              className="ml-4 font-semibold bg-violet-600 hover:bg-green-400"
              disabled={loading}
              onClick={() => {
                setLoading(true);
          ...
          <Button onClick={refresh}
              className="ml-4 font-semibold bg-violet-600 hover:bg-green-400">
                Refresh
                <RefreshCcw className="w-4 h-4 ml-2" strokeWidth={4}/>
          </Button>
        </div>
        <Separator className="flex-[1]" />
      </div>
